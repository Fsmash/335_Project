...
void init_springs(void) 
{
    ...
    for (i = 0; i < height; i++) {
        for (j = 0; j < width - 1; j++) {
            ...
            springs[nsprings].length = abs(mass[k + 1].pos[2] - mass[k].pos[2]);
    ...
    for (i = 0; i < height; i++) {
        for (j = 0; j < width - 2; j++) {
            ...
            springs[nsprings].length = abs(mass[k + 2].pos[2] - mass[k].pos[2]);
    ...
    for (i = 0; i < height; i++) {
        for (j = 0; j < width - 3; j++) {
            ...
            springs[nsprings].length = abs(mass[k + 3].pos[2] - mass[k].pos[2]);
            springs[nsprings].stiffness = 0.07;
            nsprings++;
        }
    }
    ...
    for (i = 0; i < height - 1; i++) {
        for (j = 0; j < width; j++) {
            ...
            springs[nsprings].length = abs(mass[k + width].pos[0] - mass[k].pos[0]);
            springs[nsprings].stiffness = rnd() * 0.1;
            nsprings++;
        }
    }
    ...
    for (i = 0; i < height - 2; i++) {
        for (j = 0; j < width; j++) {
            ...
            springs[nsprings].length = abs(mass[k + (width * 2)].pos[0] - mass[k].pos[0]);
            springs[nsprings].stiffness = 0.07;
            nsprings++;
        }
    }
    ...
    for (i = 0; i < height - 3; i++) {
        for (j = 0; j < width; j++) {
            ...
            springs[nsprings].length = abs(mass[k + (width * 3)].pos[0] - mass[k].pos[0]);
            springs[nsprings].stiffness = 0.07;
            nsprings++;
        }
    }
    ...
    for (i = 0; i < height; i++) {
        for (j = 0; j < width - 1; j++) {
            ...
            springs[nsprings].mass[1] = k + width;
            springs[nsprings].length = sqrt(abs(xlen * xlen + zlen * zlen));
            springs[nsprings].stiffness = 0.07;
            nsprings++;
        }
    }
...
void init_textures(void)
{
    ...
    trampolineImage = ppm6GetImage("./trampoline.ppm");
    backboardImage = ppm6GetImage("./backboard.ppm"); 
